...
@section('content')
   ...
   <section class="download-app">
      <div class="container">
         <div class="col-md-5 col-sm-5 hidden-xs"><img src="img/iphone.png" alt="iphone" class="img-responsive"/></div>
         <div class="col-md-7 col-sm-7">
            <div class="app-content">
               ...
               <a href="#" class="btn call-btn"><i class="fa fa-apple"></i>Download</a><a href="#" class="btn call-btn"><i class="fa fa-android"></i>Download</a>
            </div>
         </div>
      </div>
   </section>
